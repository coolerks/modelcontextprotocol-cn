---
title: "SEP-985: 使 OAuth 2.0 保护资源元数据与 RFC 9728 对齐"
sidebarTitle: "SEP-985: 使 OAuth 2.0 保护资源元数据与 RFC 9728 对齐"
description: "使 OAuth 2.0 保护资源元数据与 RFC 9728 对齐"
---
...
该提案使 MCP 规范对 OAuth 2.0 保护资源元数据的处理与 [RFC 9728](https://datatracker.ietf.org/doc/html/rfc9728#name-obtaining-protected-resourc) 保持一致。

---
title: "SEP-1303: 将输入验证错误作为工具执行错误"
sidebarTitle: "SEP-1303: 将输入验证错误作为工具执行错误"
description: "将输入验证错误作为工具执行错误"
---
...
本 SEP 提议将工具输入验证错误视为工具执行错误而非协议错误。此更改将使语言模型能够在其上下文窗口中接收验证错误反馈，使其能够自我纠正并在无需人工干预的情况下成功完成任务，从而显著提高任务完成率。

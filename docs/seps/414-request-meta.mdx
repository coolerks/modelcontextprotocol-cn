---
title: "SEP-414: 记录 OpenTelemetry 追踪上下文传播规范"
sidebarTitle: "SEP-414: 记录 OpenTelemetry 追踪上下文传播规范"
description: "记录 OpenTelemetry 追踪上下文传播规范"
---
...
本 SEP 记录了 MCP 中 OpenTelemetry（OTel）追踪上下文传播的规范。
